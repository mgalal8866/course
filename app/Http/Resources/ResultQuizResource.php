...
class ResultQuizResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'Result'            =>  ((isset($this->id) ? $this->quiz_result_details->count() : '0')/ (isset($this->id)? $this->quiz->question->count():'0') * 100) > $this->quiz->redirect_mark ? $this->quiz->redirect_to_up: $this->quiz->redirect_to_down ,
