                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{-- <form id="editUserForm" class="row gy-1 pt-75" > --}}
                        <div class="col-12">
                            ...
                            <input class="form-control" wire:model.live="questions.{{$key9}}.degree" type="number" id="degree{{$key9}}" step="0.1" required />
                        ...
                        <div class="col-12">
                            ...
                            <x-summernote wire:model.live="questions.{{$key9}}.testdescription" id="testdescription{{$key9}}" />
                        ...
                        <div class="col-12">
                            ...
                            <label class="form-label" for=""><i class="fas fa-question"></i>السؤال{{$key9}}</label>
                            <x-summernote wire:model.live="questions.{{$key9}}.question" id="question{{$key9}}" />
                            ...
                            <div class="card shadow-none bg-transparent border-success">
                                <div class="card-header">
                                        <div class="form-check form-check-success">
                                            <input class="form-check-input" type="radio" name="questions.0.answers" value="true" id="inlineRadio1_{{$key9}}"
                                                wire:model.live="questions.{{$key9}}.answers.{{ $key1 }}.correct" required />
                                            <label class="form-check-label" for="inlineRadio1">الاجابه الصحيحة{{$key9}}</label>
                                        </div>
                                        @error('questions'. $key9.'answers.' . $key1 . '.correct')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    <a wire:click='removeanswerquestions({{$key9}},{{ $key1 }})' class="btn btn-sm btn-danger">
                                    حذف الاجابة </a>
                                </div>
                                <div class="card-body">
                                    <div class="col-12">
                                        <label class="form-label" for=""></label>
                                        <x-summernote wire:model.live="questions.{{$key9}}.answers.{{ $key1 }}.answer"  id="answer_{{$key1}}_{{$key9}}" />
