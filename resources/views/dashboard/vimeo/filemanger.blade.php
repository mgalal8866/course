<div class="content-area-wrapper container-xxl p-0">
    @push('csslive')
        <link rel="stylesheet" type="text/css"
            href="{{ asset('asset/css-rtl/plugins/extensions/ext-component-tree.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('asset/css-rtl/pages/app-file-manager.min.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ asset('asset/vendors/css/extensions/jstree.min.css') }}">
    @endpush
                        ...
                        <div class="d-flex align-items-center">
                            <div class="file-actions">
                                ...
                                <i data-feather="alert-circle"
                                    class="font-medium-2 cursor-pointer d-sm-inline-block d-none" data-bs-toggle="modal"
                                ...
                                <div class="dropdown d-inline-block">
                                    <i class="font-medium-2 cursor-pointer" data-feather="more-vertical" role="button"
                                        id="fileActions" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                    </i>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="fileActions">
                                        ...
                                        <a class="dropdown-item d-sm-none d-block" href="#" data-bs-toggle="modal"
                        ...
                        <div class="view-container">
                            ...
                            @foreach ($data as $i)
                                @if (!isset($i['metadata']['connections']['ancestor_path'][0]['name']))
                                    <div class="card file-manager-item folder" wire:dblclick='xx($i["uri"]}})'>
                                        ...
                                        <div class="card-body">
                                            <div class="content-wrapper">
                                                <p class="card-text file-name mb-0">{{ $i['name'] }}</p>
...
@push('jslive')
    <script src="{{ asset('asset/vendors/js/extensions/jstree.min.js') }}"></script>
