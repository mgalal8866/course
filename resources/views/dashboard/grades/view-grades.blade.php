        ...
        <div class="col-12">
            <div class="card outline-success">
                <div class="card-header">
                    <h4 class="card-title">{{ __('tran.studentgrades') }}</h4>
                    <a  class="btn btn-primary" wire:click="$dispatch('edit')">{{__('tran.newstudentgrades')}}</a>

                </div>
                @livewire('dashboard.grades.new-grades')
