                                 ...
                                 <div class="row">
                                     ...
                                     <div class="mb-2 col-md-3 border border-black pb-2">
                                         <x-fileupload wire:model='file_aggregates' id='file_aggregates'
                                             :tlabel="__('tran.file_aggregates')" :namefile="$file_aggregates != null
                                 ...
                                 <div id="test">
                                     <div class="mb-1 row">
                                         <div class="col-md-2 form-check form-check-inline ">
                                             <select class="form-select" id="is_lesson">
                                         ...
                                         <div class="col-md-3">
                                             <select class="form-select" name="stage_id_" required>
