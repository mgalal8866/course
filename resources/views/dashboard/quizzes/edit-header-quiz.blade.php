            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <form id="editUserForm" class="row gy-1 pt-75"  wire:submit.prevent="save">
                        {{-- <div class="mb-1 col-md-12" wire:ignore.self >
                            <label class="form-label"
                                for="question">{{ __('tran.question') . ' ' . __('tran.course') }}</label>
                            <x-summernote wire:model='question' name="question" id="question" />
                            @error('question')
                        ...
                        <div class="mb-1 col-md-12"  >
                            <label class="form-label"
                                for="username">{{ __('tran.question')  }}</label>
                            <x-summernote wire:model='question'   name="queddddstion" id="queddddstion" />
                            @error('question')
                                <span class="error" style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="modalEditUserFirstName">{{__('tran.time')}}</label>
