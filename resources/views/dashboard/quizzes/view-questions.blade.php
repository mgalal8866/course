                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="input-group " style="width:auto; ">
                                    <a class="btn btn-outline-success btn-sm btnmodal" href="javascript:void(0)"
                                       data-id="0" data-quiz="{{ $quiz->id }}">اضافه
                                        سؤال</a>
                                    <a class="btn btn-outline-warning btn-sm edit_quiz_nmodal"
                                       data-quiz="{{ $quiz->id }}" href="javascript:void(0)">تعديل بيانات الاختبار</a>
                                </div>
                            </div>
                        </div>
