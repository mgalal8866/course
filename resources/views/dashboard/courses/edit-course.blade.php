                ...
                <div class="accordion accordion-margin" id="accordionMargin" data-toggle-hover="true">
                    ...
                    <div class="accordion-item" wire:ignore.self>
                        <h2 class="accordion-header  d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button wire:ignore.self class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="accordionMarginOne1">
                        ...
                        <div id="accordionMarginOne1" class="accordion-collapse  collapse"
                            aria-labelledby="headingMarginOne1" data-bs-parent="#accordionMargin" wire:ignore.self>
                            <div class="card">
                    ...
                    <div class="accordion-item" wire:ignore.self>
                        ...
                        <div id="accordionMarginOne2" class="accordion-collapse collapse"
                            aria-labelledby="headingMarginOne2" data-bs-parent="#accordionMargin" wire:ignore.self>
                            <div class="card">
                    ...
                    <div class="accordion-item" wire:ignore.self>
                        ...
                        <div id="accordionMarginOne3" class="accordion-collapse collapse"
                            aria-labelledby="headingMarginOne3" data-bs-parent="#accordionMargin" wire:ignore.self>
                            <div class="card">
