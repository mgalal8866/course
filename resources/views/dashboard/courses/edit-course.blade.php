                ...
                <div class="accordion accordion-margin" id="accordionMargin" data-toggle-hover="true" wire:ignore>
                    <div wire:ignore>
                        <div class="accordion-item" wire:ignore>
                            <h2 class="accordion-header  d-flex align-items-center justify-content-between"
                                id="headingMarginOne1" wire:ignore>
                                <div class="d-flex align-items-center">

                                    <buttonwire:ignore class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#accordionMarginOne1"
                                        aria-expanded="false" aria-controls="accordionMarginOne1" wire:ignore>
                            ...
                            <div id="accordionMarginOne1" class="accordion-collapse  collapse"
                                aria-labelledby="headingMarginOne1" data-bs-parent="#accordionMargin" wire:ignore>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-4">
                                                <label class="form-label"
                                                    for="username">{{ __('tran.startdate') }}</label>
                                        ...
                                        <span class="input-group-text"><i class="fas fa-calendar"></i></span> </div> --}}
                                            ...
                                            <div class="mb-1 col-md-4">
                                                <label class="form-label"
                                                    for="username">{{ __('tran.enddate') }}</label>
                                        ...
                                        <span class="input-group-text"><i class="fas fa-calendar"></i></span> </div> --}}
                                            ...
                                            <div class="mb-1 col-md-4" wire:ignore>
                                                <label class="form-label"
                                                    for="username">{{ __('tran.time') }}</label>
                                                <x-time class="form-control flatpickr-time text-start"
                                                    wire:model='time' id="time" required />
                                            ...
                                            <div class="mb-1 col-md-4">
                                                <label class="form-label"
                                                    for="validity">{{ __('tran.validity') }}</label>
                                            ...
                                            <div class="mb-1 col-md-4">
                                                <label class="form-label"
                                                    for="username">{{ __('tran.limit_stud') }}</label>
                                            ...
                                            <div class="mb-1 col-md-4">
                                                <label class="form-label"
                                                    for="username">{{ __('tran.free_tatorul') }}
                                                    :</label>
                                            ...
                                            <div class="mb-1 col-md-12">
                                                <label class="form-label"
                                                    for="username">{{ __('tran.trainers') }}</label>
                                            ...
                                            <div class="mb-1 col-md-12" wire:ignore>
                                                <label class="form-label"
                                                    for="description">{{ __('tran.description') }}</label>
                                                <x-summernote wire:model='description' name="description"
                                                    id="description" />
                                                @error('description')
                                                    <span class="error" style="color: red">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="mb-1 col-md-12" wire:ignore>
                                                <label class="form-label"
                                                    for="conditions">{{ __('tran.conditions') }}</label>
                                                <x-summernote wire:model='conditions' name="conditions"
                                                    id="conditions" />
                                                @error('conditions')
                                                    <span class="error" style="color: red">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="mb-1 col-md-12" wire:ignore>
                                                <label class="form-label"
                                                    for="">{{ __('tran.howtostart') }}</label>
                                                <x-summernote wire:model='howtostart' name="howtostart"
                                                    id="howtostart" value='{{ $howtostart }}' />
                                                @error('howtostart')
                                                    <span class="error" style="color: red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="mb-1 col-md-12" wire:ignore>
                                                ...
                                                <x-summernote wire:model='answer_the_question'
                                                    name="answer_the_question" id="answer_the_question"
                                            ...
                                            <div class="mb-1 col-md-12" wire:ignore>
                                                <label class="form-label"
                                                    for="">{{ __('tran.sections_guide') }}</label>
                        ...
                        <div class="accordion-item" wire:ignore.self>
                            <h2 class="accordion-header  d-flex align-items-center justify-content-between"
                                id="headingMarginOne2">
                                <div class="d-flex align-items-center" wire:ignore>
                                    <button wire:ignore.self class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#accordionMarginOne2"
                                        aria-expanded="false" aria-controls="accordionMarginOne2">
                            ...
                            <div id="accordionMarginOne2" class="accordion-collapse collapse"
                                aria-labelledby="headingMarginOne2" data-bs-parent="#accordionMargin"
                                wire:ignore.self>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="mb-2 col-md-6">
                                                <x-imageupload wire:model='image_course' :height='200'
                                                    :width='200' :imagenew="$image_course" :imageold="$image_course_old"
                                                    :tlabel="__('tran.imagecourse')" />
                                                @error('image_course')
                                                    <span class="error" style="color: red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="mb-2 col-md-6">
                                                <x-imageupload wire:model='calc_rate' :height='200'
                                                    :width='200' :imagenew="$calc_rate" :imageold="$calc_rate_old"
                                                    :tlabel="__('tran.calc_rate')" />
                                                @error('calc_rate')
                                                    <span class="error" style="color: red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-2 col-md-3 border border-black pb-2" wire:ignore>
                                                <x-fileupload wire:model='file_explanatory' id='file_explanatory'
                                                    :tlabel="__('tran.file_explanatory')" :namefile="$file_explanatory != null ? $file_explanatory : null" />
                                            ...
                                            <div class="mb-2 col-md-3 border border-black pb-2">
                                                <x-fileupload wire:model='file_aggregates' id='file_aggregates'
                                                    :tlabel="__('tran.file_aggregates')" :namefile="$file_aggregates != null ? $file_aggregates : null" />
                                            ...
                                            <div class="mb-2 col-md-3 border border-black pb-2">
                                                <x-fileupload wire:model='file_supplementary' id='file_supplementary'
                                                    :tlabel="__('tran.file_supplementary')" :namefile="$file_supplementary != null ? $file_supplementary : null" />
                        ...
                        <div class="accordion-item" wire:ignore.self>
                            <h2 class="accordion-header  d-flex align-items-center justify-content-between"
                                id="headingMarginOne3">
                                <div class="d-flex align-items-center">
                                    <button wire:ignore.self class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#accordionMarginOne3"
                                        aria-expanded="false" aria-controls="accordionMarginOne3">
                                        <span class="text-warning">{{ __('tran.setcourse') }}</span>
                                    </button>
                                </div>
                            </h2>
                            <div id="accordionMarginOne3" class="accordion-collapse collapse"
                                aria-labelledby="headingMarginOne3" data-bs-parent="#accordionMargin"
                                wire:ignore.self>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="mb-1 col-md-3">
                                                <x-check wire:model='langcourse' id="langcourse" left="En"
                                                    right="Ar" :tlabel="__('tran.langcourse')" />
                                            </div>
                                            <div class="mb-1 col-md-3">
                                                <x-check wire:model='inputnum' id="inputnum" left="En"
                                                    right="Ar" :tlabel="__('tran.inputnum')" />
                                            </div>
                                            <div class="mb-1 col-md-3">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label"
                                                    for="telegram">{{ __('tran.telegram') }}</label>
                                                <div class="input-group input-group-merge">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                <label class="form-label"
                                                    for="nextcourse">{{ __('tran.nextcourse') }}</label>
                    ...
                    <div class="accordion-item" wire:ignore.self>
                        <h2 class="accordion-header  d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex align-items-center">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#accordionMarginOne4" aria-expanded="false"
                            ...
                            <div class="button-group p-1" wire:ignore.self>
                                ...
                                <a target="_blank" href="{{ route('newcourse2', ['id' => $id]) }}"
                                    class="btn btn-success btn-sm">اضافة دروس</a>
                            </div>
                        ...
                        <div id="accordionMarginOne4" class="accordion-collapse collapse"
                            aria-labelledby="headingMarginOne4" data-bs-parent="#accordionMargin">
                            <div class="card">
                                    ...
                                    @if (count($lessons) > 0)
                                        @foreach ($lessons as $key => $value)
                                            <div class="mb-1 row">
                                                ...
                                                @if ($lessons[$key]['is_lesson'] != 0   && $lessons[$key]['is_lesson'] !=3  )
                                                    <div class="col">
                                                        <input class="form-control"
                                                            wire:model="lessons.{{ $key }}.name"
                                                            placeholder="{{ $lessons[$key]['is_lesson'] == 1 ? 'اسم الشرح' : 
                                                            ($lessons[$key]['is_lesson'] == 0 ? 'اسم تدريب' :  ($lessons[$key]['is_lesson'] == 3 ? 'محاكى ' : 'اسم بث مباشر'))
                                                             }}"
                                                            type="text" />
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input class="form-control"
                                                            wire:model="lessons.{{ $key }}.link"
                                                            type="text"
                                                            placeholder="{{ $lessons[$key]['is_lesson'] == 1 ? 'اسم الشرح' : 
                                                            ($lessons[$key]['is_lesson'] == 0 ? 'اسم تدريب' :  ($lessons[$key]['is_lesson'] == 3 ? 'محاكى ' .$lessons[$key]['is_lesson'] : 'اسم بث مباشر'))
                                                             }}" />
